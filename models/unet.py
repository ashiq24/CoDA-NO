...
class UnetGno(nn.Module):
    def __init__(
        ...
        self.base = UNet2d(
            in_channels=hidden_dim, out_channels=hidden_dim, init_features=hidden_dim
        )
    ...
    def get_output_scaling_factor(self, initial_scale, scalings_per_layer):
        ...
        Args:
            initial_scale (list or float): The initial scaling factor.
            scalings_per_layer (list): A list of scaling factors per layer.

        Returns:
            float: The final output scaling factor.
