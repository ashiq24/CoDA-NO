...
class VitGno(nn.Module):
    def __init__(
        ...
        self.expander = nn.Linear(
            ...
            * hidden_dim
            // self.contraction_factor,
            self.grid_size[0] * self.grid_size[1] * hidden_dim,
        )
        if self.projection:
    ...
    def get_output_scaling_factor(self, initial_scale, scalings_per_layer):
        ...
        Args:
            ...
            scalings_per_layer (list): List of scaling factors per layer.
    ...
    def forward(self, inp, out_grid_displacement=None, in_grid_displacement=None):
        ...
        Args:
            ...
            out_grid_displacement (torch.Tensor, optional): Output grid displacement tensor. Defaults to None.
            in_grid_displacement (torch.Tensor, optional): Input grid displacement tensor. Defaults to None.
        ...
        if out_grid_displacement is not None:
            with torch.no_grad():
                self.lifting.update_grid(self.initial_mesh + in_grid_displacement, None)
