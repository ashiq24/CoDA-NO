...
class GnnLayer(nn.Module):
    def __init__(
        ...
        self.neighbour = NS(
            input_grid.clone().cpu(), output_grid.clone().cpu(), n_neigbor=n_neigbor
        )
    ...
    def update_grid(self, input_grid=None, output_grid=None):
        """
        Update the input and output grids for the GNN layer.
    ...
    def forward(self, inp):
        ...
        Returns:
            torch.Tensor: Output tensor after applying the GNN layer.
