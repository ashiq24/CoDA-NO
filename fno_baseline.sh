# python main.py --config fno_NSES_1 --ntrain 100
python main.py --config fno_NSES_5 --ntrain 100
# python main.py --config fno_NSES_10 --ntrain 100
# python main.py --config fno_NS_1 --ntrain 100
python main.py --config fno_NS_5 --ntrain 100
# python main.py --config fno_NS_10 --ntrain 100
