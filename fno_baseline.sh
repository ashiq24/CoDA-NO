python main.py --config fno_NSES_1 --ntrain 5
python main.py --config fno_NSES_5 --ntrain 5
python main.py --config fno_NSES_10 --ntrain 5
python main.py --config fno_NS_1 --ntrain 5
python main.py --config fno_NS_5 --ntrain 5
python main.py --config fno_NS_10 --ntrain 5
